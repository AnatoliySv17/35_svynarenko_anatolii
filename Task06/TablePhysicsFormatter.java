...
public class TablePhysicsFormatter implements PhysicsFormatter {
    ...
    private void outBodyFormat(double x,double y,double x1,double y1,double result){
        int space = InstallSpacing();
        System.out.printf("%s"+"%"+space+"."+decimalPl+"f"+"%"+space+"s"+"%"+space+"."+decimalPl+"f"+"%"+space+"s"+"%"+space+"."+decimalPl+"f"+"%"+space+"s"+"%"+space+"."+decimalPl+"f"+"%"+space+"s"+"%"+space+"."+decimalPl+"f"+"%"+(space-1)+"s",
                "| ",x,"| ",y,"| ",x1,"| ",y1,"| ",result,"|\n");
    }
    ...
    private void  outBodyFormatForce(double mass1,double mass2,double distance,double result){
        int space = InstallSpacing();
        System.out.printf("%s"+"%"+space+"."+decimalPl+"f"+"%"+space+"s"+"%"+space+"."+decimalPl+"f"+"%"+space+"s"+"%"+space+"."+decimalPl+"f"+"%"+space+"s"+"%"+space+"."+decimalPl+"e"+"%"+(space-1)+"s",
                "| ",mass1,"| ",mass2,"| ",distance,"| ",result,"|\n");
    }
