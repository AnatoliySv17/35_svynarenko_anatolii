...
public class PhysicsApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter table width(from 10): ");
        int tablewidth = scanner.nextInt();
        System.out.println("Enter decimal place: ");
        ...
        while (true) {
            ...
            switch (option) {
                case 1 -> {
                    ...
                    TablePhysicsFormatter tablePhysicsFormatter = new TablePhysicsFormatter(tableplace,tablewidth);
